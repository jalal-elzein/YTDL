...
# This tells Windows to let the app render at full resolution
try:
...
class YTDLGui:
    def __init__(self, root):
        ...
        self.setup_ui()
        self.root.geometry("700x450") # Bumped up from 500x350
    ...
    def setup_ui(self):
        ...
        ttk.Combobox(options_frame, textvariable=self.format_var, values=["mp3", "m4a", "webm", "mp4"], width=5).pack(side="left")
